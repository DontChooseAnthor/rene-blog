  ...
  <div class="promise-resource">
    ...
    <div class="container">
      ...
      <div class="article">
        ...
        <div class="begin">如果把ES6比作一顶皇冠的话，那Promise大概就是皇冠上的一颗珍珠。它作为一种新的异步执行解决方式，一直都是面试官所青睐的提问对象，我想借这次机会稍微揭开Promise的神秘面纱~</div>
        ...
        <div class="section-container">
          all方法是将多个Promise对象包装成一个新的Promise对象，它有以下几个特点
            1. all返回的Promise对象的状态只有在所有子对象状态都是resolved才是resolved，其它情况返回rejected
            2. all返回的Promise的完成状态的结果是一个数组
            3. 如果参数不包含Promise对象，则返回一个异步完成
        </div>
        ...
        <div class="section-container">
          resolve接受的参数分四种情况
            1. 参数是Promise实例：resolve不做任何改变并返回这个实例
            2. 参数是thenable对象：thenable对象是指具有then方法的对象，在将对象转化为Promise对象后，就会立即执行thenable对象的then方法
            3. 参数不是对象：返回一个状态为resolved的新Promise对象
            4. 没有参数：直接返回一个状态为resolved的新Promise对象
        </div>
